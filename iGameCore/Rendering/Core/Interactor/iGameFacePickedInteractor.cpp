...
void FacePickedInteractor::SetFacesAndPainter(Points::Pointer points,
...
bool FacePickedInteractor::IsIntersectTriangle(igm::vec3 orig, igm::vec3 end,
                                               igm::vec3 v0,
                         igm::vec3 v1, igm::vec3 v2, igm::vec3& intersection) {
...
double FacePickedInteractor::DistancePointToPlane(igm::vec3 point, igm::vec3 p1,
                                                  igm::vec3 p2,
                            igm::vec3 p3) {
