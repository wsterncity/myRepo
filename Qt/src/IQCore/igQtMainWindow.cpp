...
void igQtMainWindow::initAllComponents() {
  ...
  // connect(ui->action_setViewTo_X, &QAction::triggered, rendererWidget,
  // &igQtModelDrawWidget::UpdateCurrentViewToXP);
  // connect(ui->action_setViewTo_X1, &QAction::triggered, rendererWidget,
  // &igQtModelDrawWidget::UpdateCurrentViewToXN);
  // connect(ui->action_setViewTo_Y, &QAction::triggered, rendererWidget,
  // &igQtModelDrawWidget::UpdateCurrentViewToYP);
  // connect(ui->action_setViewTo_Y1, &QAction::triggered, rendererWidget,
  // &igQtModelDrawWidget::UpdateCurrentViewToYN);
  // connect(ui->action_setViewTo_Z, &QAction::triggered, rendererWidget,
  // &igQtModelDrawWidget::UpdateCurrentViewToZP);
  // connect(ui->action_setViewTo_Z1, &QAction::triggered, rendererWidget,
  // &igQtModelDrawWidget::UpdateCurrentViewToZN);
...
void igQtMainWindow::initAllFilters() {
  ...
  connect(ui->action_test_06, &QAction::triggered, this, [&](bool checked) {
    ...
    points->AddPoint(10, 20, 0);
    points->AddPoint(20, 20, 0);
    points->AddPoint(20, 20, 12);
  ...
  connect(action, &QAction::triggered, this, [&](bool checked) {
    ...
    fp->Execute(input);
    SceneManager::Instance()->GetCurrentScene()->ChangeModelVisibility(0,
                                                                       false);
  ...
  connect(action_subdivision, &QAction::triggered, this, [&](bool checked) {
    ...
    // DynamicCast<SurfaceMesh>(rendererWidget->GetScene()->GetCurrentModel()->GetDataObject());
    filter->SetMesh(mesh);
    filter->Execute();
...
void igQtMainWindow::initAllMySignalConnections() {
  ...
  // ui->modelTreeView, &igQtModelListView::UpdateModelList);
...
void igQtMainWindow::initAllSources() {
  ...
  connect(ui->action_LineSource, &QAction::triggered, this, [&]() {
    //        UnstructuredMesh::Pointer newLinePointSet =
    //        UnstructuredMesh::New(); newLinePointSet->SetViewStyle(IG_POINTS);
    ...
    //
    //        LineTypePointsSource::Pointer lineSource =
    //        LineTypePointsSource::New();
    //
    ...
    /*  auto interactor = LineSourceInteractor::New();
       ...
       model); interactor->SetFilter(lineSource);*/
